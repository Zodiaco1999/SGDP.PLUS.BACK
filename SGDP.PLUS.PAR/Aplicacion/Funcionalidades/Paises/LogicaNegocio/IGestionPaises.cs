...
{
    Task<DataViewModel<ConsultarPaisesResponse>> ConsultarPaises(string filtro, int pagina, int registrosPorPagina,string? ordenarPor = null, bool? direccionOrdenamientoAsc = null);
